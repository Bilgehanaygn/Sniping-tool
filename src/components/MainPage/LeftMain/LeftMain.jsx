...
const LeftMain = () => {
    ...
    return (
        <div style={styles.mainDiv}>
            ...
            <button className="menu-item" style={state.currentPage === 3 ? {...styles.selectedMenuItem, cursor:state.autoBuyRunning ? "not-allowed" : "pointer" } : {cursor:state.autoBuyRunning ? "not-allowed" : "pointer"} }>
                ⛏️ 
                <span style={{marginLeft:"1vw"}} >Minting Tool</span>
            </button>
            <button className="menu-item" style={state.currentPage === 4 ? {...styles.selectedMenuItem, cursor:state.autoBuyRunning ? "not-allowed" : "pointer" } : {cursor:state.autoBuyRunning ? "not-allowed" : "pointer"} }>
            ...
            <button className="menu-item" style={state.currentPage === 5 ? {...styles.selectedMenuItem, cursor:state.autoBuyRunning ? "not-allowed" : "pointer" } : {cursor:state.autoBuyRunning ? "not-allowed" : "pointer"} }>
            ...
            <button className="menu-item" style={state.currentPage === 6 ? {...styles.selectedMenuItem, cursor:state.autoBuyRunning ? "not-allowed" : "pointer" } : {cursor:state.autoBuyRunning ? "not-allowed" : "pointer"} }>
