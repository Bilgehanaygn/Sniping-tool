...
const LeftMain = () => {
    ...
    return (
        <div style={styles.mainDiv}>
            ...
            <button className="menu-item" disabled={state.autoBuyRunning} style={{ cursor:state.autoBuyRunning ? "not-allowed" : "pointer" }}>
                <span style={{marginRight:"1vw"}} >👀</span>NFT Eyez
            </button>
