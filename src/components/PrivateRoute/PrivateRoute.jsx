...
const WelcomePage = () => {
    ...
    return (
        <div style={{width:"100vw", height:"100vh", display:"flex",flexDirection:"row", alignItems:"center", backgroundColor:"#000"}} >
            <img style={{width:"40%", height:"80%"}} src={baseLogoImage} />
            <div style={{height:"100%"}} >
                <img style={{width:"50vw", height:"30%"}} src={fontNew}  />
                <div style={{color:`${theme.primary}`, fontSize:"2em"}} >
                    An all in one tool crafted for SolShot Community.
                </div>
                <div style={{color:"white", fontSize:"4em", width:"100%", textAlign:"center", marginTop:"10vh"}} >
                    07:25:50
                </div>
                <div style={{display:"flex", flexDirection:"row", margin:"auto", marginTop:"5vh", justifyContent:"center", alignItems:"center"}} >
