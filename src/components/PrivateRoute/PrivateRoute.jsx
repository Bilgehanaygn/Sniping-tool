...
const PrivateRoute = ({children}) => {
    ...
    useEffect(async () => {
        ...
        const nftsByOwner = await axios.get(`https://api-mainnet.magiceden.dev/v2/wallets/${publicKey.toBase58()}/tokens?offset=0&limit=100&listStatus=unlisted`);

        for(let item of nftsByOwner.data){
            if(item?.updateAuthority?.toString() === 'GU9MLzrLcL1LdSE38uQUUHFjsHnSmnwsGKfytunYnpqX'){
                setIsHolder(true);
                break;
            }
        }
